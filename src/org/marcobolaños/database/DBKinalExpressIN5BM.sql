...
call sp_AgregarClientes(3, '111111-2', 'Azael', 'Martinez', 'Pollo Campero', 98999963, 'amartinez-2020000');
call sp_AgregarClientes(4, '666663-2', 'Antonio', 'Kroos', 'Santiago Bernabeu', 85745563, 'akroos-2022130');
call sp_AgregarClientes(5, '666663-2', 'Eduardo', 'Kroos', 'Santiago Bernabeu', 85745563, 'ekroos-2022100');
...
call sp_crearFactura(3, 'pagado', '400.95', '10 de mayo 2024', 3, 3);
call sp_crearFactura(4, 'pagado', '767.65', '19 de julio 2024', 4, 4);
call sp_crearFactura(5, 'pagado', '1000.95', '22 de junio 2024', 5, 5);
...
begin
	...
	where Factura.numeroDeFactura = new.numeroDeFactura;
end $$
delimiter ;
 
create view vw_Productos as
select Productos.codigoProducto, Productos.precioUnitario, Productos.precioDocena, Productos.precioMayor, Productos.existencia, TipoProducto.Descripcion, Proveedores.nombreProveedor
from Productos
...
select * from DetalleFactura
    ...
    join Clientes on Factura.codigoCliente = Clientes.clienteID
